                    ...
                    <tbody>
                        ...
                        {props.licenses.data.map((license,key) => (
                            <tr>
                                ...
                                <td className="border px-2 py-2"><div class="form-label" bis_skin_checked="1" id={'valid-status-'+license.id}>{parse(validedChecked(license.expiration_date,license.buy_date,license?.transaction?.refund))}</div></td>
                            </tr>
                        ))}
